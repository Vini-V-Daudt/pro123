...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print("tamanho da tela:", screen_width, screen_height, "tamanho janela", width, height)
		print("posicao mouse:", mouse.position, "posicao central da linha das pontas:", center_x, center_y )
